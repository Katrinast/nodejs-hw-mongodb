...
router.post('/', upload.single('photo'), validateBody(createContactsSchema), ctrlWrapper(postContactsController));
router.patch('/:contactId', isValiId, upload.single('photo'), validateBody(updateContactSchema), ctrlWrapper(patchContactByIdController));
